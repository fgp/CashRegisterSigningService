...
public class SmartCardACOS extends AbstractCashRegisterSmartCard {
	...
	public SmartCardACOS(Card card) throws SmartCardException {
	...
	@Override
	public byte[] doSignaturWithoutSelection(byte[] sha256Hash, String pinS) throws SmartCardException {
	...
	private long getCertificateSerial() throws SmartCardException, CardException {
