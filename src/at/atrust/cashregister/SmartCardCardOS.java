...
public class SmartCardCardOS extends AbstractCashRegisterSmartCard {
	...
	public SmartCardCardOS(Card card) throws SmartCardException {
	...
	@Override
	public byte[] doSignatur(byte[] sha256Hash, String pin) throws SmartCardException {
	...
	@Override
	public byte[] doSignaturWithoutSelection(byte[] sha256Hash, String pin) throws SmartCardException {
	...
	@Override
	public String getCertificateSerialDecimal() throws SmartCardException, CardException {
	...
	@Override
	public String getCertificateSerialHex() throws SmartCardException, CardException {
	...
	@Override
	public X509CertificateHolder getCertificate() throws SmartCardException, CardException {
		List<byte[]> dataList = getBuffer(false, DF_SIG, EF_C_CH_DS);
		return SmartCardUtil.buildX509Certificate(dataList);
	}

	@Override
	public String getCIN() throws SmartCardException, CardException {
		executeSelectWithFileIdAPDU(MASTER_FILE);
	...
	private BigInteger getCertificateSerial() throws SmartCardException, CardException {
	...
	private boolean applicationsMissing() throws SmartCardException {
